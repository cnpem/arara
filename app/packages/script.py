...
def run_subprocess(proc_command, a, b, c, alpha, beta, gamma):
...
def return_spots_data(first_image_path):
    ...
    a, b, c, alpha, beta, gamma = run_subprocess(proc_command, a, b, c, alpha, beta, gamma)
    ...
    return x_values, y_values, intensity_values, a, b, c, alpha, beta, gamma
