...
const shortBaseDir = import.meta.env.VITE_SHORT_BASE_DIR
...
function FileBrowserModal ({ setConfig, setConfigCache, onClose } : Readonly<FileBrowserModalProps> ) {
  ...
  const fetchFiles = async (path: string) => {
    ...
    const res = await fetch(`${apiUrl}/list_files`, {
      method: 'POST',
      credentials: 'include',
      headers: { 
